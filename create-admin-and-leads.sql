-- =============================================
-- CREATE ADMIN USER AND LEADS MARKETPLACE
...
-- =============================================
-- 2. CREATE ADMIN USER IN PUBLIC.USERS TABLE
-- =============================================

-- First, let's check if we have any users at all
-- If no users exist, we'll create an admin user
-- If users exist but no admin, we'll create one

-- Create admin user with a new UUID
...
SELECT 
  ...
  NOW()
WHERE NOT EXISTS (
  SELECT 1 FROM public.users WHERE email = 'admin@travelplatform.com'
);
...
-- =============================================
-- 5. CREATE PURCHASED LEADS TABLE
-- =============================================
...
-- Insert sample leads using the admin user ID
