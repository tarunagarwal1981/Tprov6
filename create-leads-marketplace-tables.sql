-- =============================================
-- CREATE LEADS MARKETPLACE TABLES AND SAMPLE DATA
...
-- =============================================
-- 6. FIND EXISTING ADMIN USER
-- =============================================

-- Let's find the existing admin user and use their ID
-- This will show you the admin user details so you can verify the correct ID
SELECT 
  id, 
  email, 
  name, 
  role,
  'Use this ID for admin_id in leads' as note
FROM public.users 
WHERE role = 'ADMIN' 
LIMIT 1;
...
-- Replace 'YOUR_ADMIN_USER_ID' with the actual admin user ID from the query above
